      ...
      <div className="w-full lg:w-1/4 bg-white px-4">
        ...
        {isSearched &&
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              <h3 className="font-medium text-xl mb-4">Current Search</h3>
              <div className="mb-4 text-gray-600">
                {searchFilter.title && (
                  <span className="inline-flex items-center gap-2.5 bg-blue-50 border border-blue-200 px-4 py-2.5 rounded">
                    {searchFilter.title}
                    <img
                      onClick={(e) =>
                ...
                {searchFilter.location && (
                  <span className="ml-2 inline-flex items-center gap-2.5 bg-red-50 border border-red-200 px-4 py-2.5 rounded">
                    {searchFilter.location}
                    <img
                      onClick={(e) =>
        ...
        {/* Location Filter */}
        <div className={showFilter ? "" : "max-lg:hidden"}>
          <h4 className="font-medium text-lg pt-14 py-4">
            Search by Locations
          </h4>
          <ul className="space-y-4 text-gray-600">
